...
return [
  ...
  */
  ...
  'providers' => [
    ...
    App\Providers\NoSQLDataSourceServiceProvider::class,
    ...
    App\Providers\MailListServiceProvider::class,
    App\Providers\AffiliateServiceProvider::class,
    App\Providers\PopupServiceProvider::class,
    ...
    App\Providers\StockLocationServiceProvider::class,
    ...
    App\Providers\GiftCardServiceProvider::class
  ],
